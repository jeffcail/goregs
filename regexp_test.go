...
func TestGoRegs_RegNumber(t *testing.T) {
	//var a = "1234你好"
	//var a = "1234.45"
	var a = "1234.4$5"
	fmt.Println(r.MatchIntOrFloat(a))
...
func TestGoRegs_RegLenNNumber(t *testing.T) {
	//var a = "1234.45"
	var a = "123445"
	fmt.Println(r.MatchLenNNumber(a, 6))
}

func TestGoRegs_RegGeNNumber(t *testing.T) {
	var a = "123446"
	fmt.Println(r.MatchLenNNumber(a, 6))
}

func TestGoRegs_RegMNIntervalNumber(t *testing.T) {
	var a = "12312211121212"
	fmt.Println(r.MatchMNIntervalNumber(a, 4, 12))
}

func TestGoRegs_RegStartingWithNonZero(t *testing.T) {
	var a = "00123445"
	fmt.Println(r.MatchStartingWithNonZero(a))
}

func TestGoRegs_RegNNovelsOfRealNumber(t *testing.T) {
	//var a = "12.00"
	var a = "12"
	fmt.Println(r.MatchNNovelsOfRealNumber(a, 3))
}

func TestGoRegs_RegMNNovelsOfRealNumber(t *testing.T) {
	var a = "12.1222"
	//var a = "12"
	fmt.Println(r.MatchMNNovelsOfRealNumber(a, 2, 6))
}

func TestGoRegs_RegNanZeroNumber(t *testing.T) {
	var a = "-1"
	//var a = "12"
	fmt.Println(r.MatchNanZeroNumber(a))
}

func TestGoRegs_RegNanZeroNegNumber(t *testing.T) {
	var a = "-1"
	//var a = "12"
	fmt.Println(r.MatchNanZeroNegNumber(a))
}

func TestGoRegs_RegNLeCharacter(t *testing.T) {
	//var a = "-1)1"
	var a = "小泽玛"
	fmt.Println(r.MatchNLeCharacter(a, 3))
}

func TestGoRegs_RegEnCharacter(t *testing.T) {
	//var a = "-1)1"
	var a = "abc0"
	fmt.Println(r.MatchEnCharacter(a))
}

func TestGoRegs_RegUpEnCharacter(t *testing.T) {
	var a = "ABC"
	fmt.Println(r.MatchUpEnCharacter(a))
}

func TestGoRegs_RegLowerEnCharacter(t *testing.T) {
	var a = "abc"
	fmt.Println(r.MatchLowerEnCharacter(a))
}

func TestGoRegs_RegNumberEnCharacter(t *testing.T) {
	var a = "abc12?"
	fmt.Println(r.MatchNumberEnCharacter(a))
}

func TestGoRegs_RegNumberEnUnderscores(t *testing.T) {
	var a = "abc12_"
	//var a = "_abc12"
	fmt.Println(r.MatchNumberEnUnderscores(a))
}

func TestGoRegs_RegPass1(t *testing.T) {
	//var a = "abc12_121232131231?"
	var a = "a_abc12"
	fmt.Println(r.MatchPass1(a, 4, 12))
}

func TestGoRegs_RegIsContainSpecialCharacter(t *testing.T) {
	// 测试字符串
	testStrings := []string{
		"Hello, World!",
		"GoLang123",
...
func TestGoRegs_RegChineseCharacter(t *testing.T) {
	// 测试字符串
	testStrings := []string{
		"你好世界",      // 纯汉字
		"Hello",     // 非汉字
...
func TestGoRegs_RegEmail(t *testing.T) {
	var a = "aabc@qq.com"
	fmt.Println(r.MatchEmail(a))
}

func TestGoRegs_RegChinePhoneNumber(t *testing.T) {
	testNumbers := []string{
		"13800138000", // valid
		"12345678901", // invalid
		"19912345678", // valid
...
func TestGoRegs_RegContainChineseCharacter(t *testing.T) {
	testStrings := []string{
...
func TestGoRegs_MatchDoubleByte(t *testing.T) {
	testStrings := []string{
...
func TestGoRegs_MatchEmptyLine(t *testing.T) {
	testStrings := []string{
...
func TestGoRegs_MatchIPv4(t *testing.T) {
	testIPs := []string{
		"192.168.1.1",     // valid
...
func TestGoRegs_MatchIPv6(t *testing.T) {
	testIPs := []string{
